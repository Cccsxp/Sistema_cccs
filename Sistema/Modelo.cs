...
namespace Sistema
{
    class Modelo
    {
        public int registro(Usuarios usuario)
        {
            ...
            string sql = "INSERT INTO usuarios (usuario, password, nombre, direccion, telefono, cedula, ciudad, correo, area, documento, id_tipo) VALUES(@usuario, @password, @nombre, @direccion, @telefono, @cedula, @ciudad, @correo, @area, @documento, @id_tipo)";
            ...
            comando.Parameters.AddWithValue("@Area", usuario.Area);
